const pattern15Spark = new Pattern({
  id: 15,
  name: "Spark",
  ...
  slots: {
    trigger:
      "What initiates ignition: anomaly spike, symbolic tension, threshold crossing, energy surplus, phase compression.",
    catalyst:
      "The mechanism of amplification: resonance, positive feedback, symbolic amplification, energy release, cross-modal excitation.",
    emergence:
      "The new behavior or structure: new_pathway, emergent_action, spontaneous_defense, novel_embedding, new_attractor."
  },
  examples: [
    {
...
PATTERNS[pattern15Spark.id] = pattern15Spark;


function renderSpark(trigger, catalyst, emergence) {
  return `SPARK ${trigger} via ${catalyst} => ${emergence}`;
}